...
const HeaderAdmin: FC = () => {
    ...
    <div className="bg-[#27374D] text-[#DDE6ED] w-screen fixed top-0  flex flex-row items-center gap-1 p-1 px-5  xl:gap-5 xl:p-1 xl:px-10  ">
        ...
        <Link to="/student/leavePage" className="2xl:text-2xl border border-[#27374D] hover:bg-[#DDE6ED] hover:text-[#27374D] p-2 rounded-md hover:cursor-pointer">Student Page</Link>
        ...
        <Link to="/admin/userlist" className="2xl:text-2xl ml-auto border border-[#27374D] hover:bg-[#DDE6ED] hover:text-[#27374D] p-2 rounded-md hover:cursor-pointer">User</Link>
